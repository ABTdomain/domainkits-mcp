...
- Claude Code: `claude mcp add --transport http domainkits https://api.domainkits.com/v1/mcp`
- Setup for Claude.ai, Claude Desktop, Gemini CLI, Cursor: [domainkits.com/mcp](https://domainkits.com/mcp)
